...
# IAM Role for Lambda
resource "aws_iam_role" "reevent_lambda_role" {
...
resource "aws_iam_role_policy_attachment" "lambda_basic_execution" {
  role       = aws_iam_role.reevent_lambda_role.name
...
resource "aws_lambda_function" "post_confirmation" {
  filename         = "../backend/lambdas/user/auth-post-confirmation.zip"
  function_name    = "${var.project_name}-auth-post-confirmation-${var.environment}"
  role            = aws_iam_role.reevent_lambda_role.arn
